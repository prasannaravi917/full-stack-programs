...
function WeatherForescast(){
const[forescast,setForecast]=useState(null);
...
display:'grid',
placeItems:'center',
background:'linear-gradient(-45deg,#ee7752,#e73c7e,#e23a6d5,#23d5ab)',
...
export deafault WeatherForecast;
